...
3. Preserve official casing: **AnyPick**.
...
The app-icon SVG contains an intentional optical shift. Do not apply auto-center transforms to the internal symbol.
