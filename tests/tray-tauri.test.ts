...
import { nativeTrayIconsetEntries, nativeTrayNeedsRestart } from '../src/tray/supervisor-native';
...
describe('Tauri tray helper resolution', () => {
  ...
  it('uses the standard macOS iconset filenames for every retina size', () => {
    expect(nativeTrayIconsetEntries).toEqual([
      ['icon_16x16.png', 16],
