...
export interface HotplugHomeScreenProps {
...
export function HotplugHomeScreen(props: HotplugHomeScreenProps) {
  const {
    model,
    selectedIndex,
    columns,
